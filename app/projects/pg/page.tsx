...
export default function ProgrammingQuiz() {
  ...
  const questions: Question[] = [
    ...
    {
      question: "Apa preferensimu untuk sistem tipe?",
      options: [
        {
          text: "Aku lebih suka dynamic typing untuk fleksibilitas",
          scores: {
            javascript: 5,
            typescript: 2,
            python: 5,
        ...
        {
          text: "Aku lebih suka static typing untuk keamanan dan tooling",
          scores: {
            javascript: 2,
            typescript: 5,
            python: 2,
        ...
        {
          text: "Aku suka sistem typing opsional/bertahap",
          scores: {
            javascript: 3,
            typescript: 5,
            python: 4,
        ...
        {
          text: "Aku tidak punya preferensi yang kuat",
          scores: {
            javascript: 4,
            typescript: 4,
            python: 4,
        ...
        {
          text: "Aku lebih suka type inference yang kuat",
          scores: {
            javascript: 2,
            typescript: 4,
            python: 2,
    ...
    {
      question: "Jenis aplikasi apa yang ingin kamu buat?",
      options: [
        {
          text: "Aplikasi web dan situs",
          scores: {
            javascript: 5,
            typescript: 5,
            python: 4,
        ...
        {
          text: "Aplikasi dengan data intensif",
          scores: {
            javascript: 3,
            typescript: 3,
            python: 5,
        ...
        {
          text: "Tools sistem dan infrastruktur",
          scores: {
            javascript: 2,
            typescript: 3,
            python: 3,
    ...
    {
      question: "Seberapa penting performa untuk proyekmu?",
      options: [
        {
          text: "Sangat penting - butuh performa maksimal",
          scores: {
            javascript: 2,
            typescript: 3,
            python: 1,
        ...
        {
          text: "Penting, tapi aku rela menukar sebagian untuk produktivitas",
          scores: {
            javascript: 3,
            typescript: 4,
            python: 2,
        ...
        {
          text: "Cukup penting - performa aplikasi web biasa sudah cukup",
          scores: {
            javascript: 4,
            typescript: 4,
            python: 4,
        ...
        {
          text: "Tidak terlalu penting untuk kasus penggunaanku",
          scores: {
            javascript: 5,
            typescript: 4,
            python: 5,
        ...
        {
          text: "Performa real-time sangat krusial",
          scores: {
            javascript: 1,
            typescript: 2,
            python: 1,
    ...
    {
      question: "Seberapa kamu menghargai ekosistem library dan framework yang besar?",
      options: [
        {
          text: "Sangat penting - aku ingin ekosistem luas dengan solusi untuk segalanya",
          scores: {
            javascript: 5,
            typescript: 5,
            python: 5,
        ...
        {
          text: "Penting, tapi kualitas lebih penting daripada kuantitas",
          scores: {
            javascript: 4,
            typescript: 5,
            python: 4,
        ...
        {
          text: "Agak penting, tapi aku bisa membangun sendiri jika perlu",
          scores: {
            javascript: 3,
            typescript: 3,
            python: 3,
        ...
        {
          text: "Tidak terlalu penting - aku lebih suka ekosistem yang lebih kecil dan fokus",
          scores: {
            javascript: 2,
            typescript: 2,
            python: 2,
        ...
        {
          text: "Aku lebih suka ekosistem yang terkurasi dan terawat dengan baik",
          scores: {
            javascript: 3,
            typescript: 4,
            python: 3,
    ...
    {
      question: "Berapa level pengalamanmu dengan pemrograman?",
      options: [
        {
          text: "Pemula - baru mulai",
          scores: {
            javascript: 5,
            typescript: 3,
            python: 5,
        ...
        {
          text: "Menengah - nyaman dengan dasar-dasar",
          scores: {
            javascript: 5,
            typescript: 4,
            python: 5,
        ...
        {
          text: "Lanjutan - developer berpengalaman",
          scores: {
            javascript: 4,
            typescript: 5,
            python: 4,
        ...
        {
          text: "Ahli - bertahun-tahun pengalaman",
          scores: {
            javascript: 4,
            typescript: 5,
            python: 4,
        ...
        {
          text: "Aku punya pengalaman di domain spesifik (misal, web, mobile)",
          scores: {
            javascript: 5,
            typescript: 5,
            python: 5,
    ...
    {
      question: "Seberapa penting dukungan komunitas dan sumber daya?",
      options: [
        {
          text: "Sangat penting - aku mengandalkan bantuan komunitas",
          scores: {
            javascript: 5,
            typescript: 5,
            python: 5,
        ...
        {
          text: "Penting, tapi aku juga bisa mencari tahu sendiri",
          scores: {
            javascript: 4,
            typescript: 4,
            python: 4,
        ...
        {
          text: "Agak penting, tapi bukan faktor penentu",
          scores: {
            javascript: 3,
            typescript: 3,
            python: 3,
        ...
        {
          text: "Tidak terlalu penting - aku lebih suka memecahkan masalah sendiri",
          scores: {
            javascript: 3,
            typescript: 3,
            python: 3,
        ...
        {
          text: "Aku lebih suka dokumentasi resmi daripada dukungan komunitas",
          scores: {
            javascript: 4,
            typescript: 5,
            python: 4,
    ...
    {
      question: "Apa lingkungan deployment yang kamu sukai?",
      options: [
        {
          text: "Hosting web tradisional (shared hosting, dll)",
          scores: {
            javascript: 4,
            typescript: 3,
            python: 3,
        ...
        {
          text: "Platform cloud (AWS, Azure, GCP)",
          scores: {
            javascript: 5,
            typescript: 5,
            python: 5,
        ...
        {
          text: "Lingkungan container (Docker, Kubernetes)",
          scores: {
            javascript: 4,
            typescript: 4,
            python: 4,
        ...
        {
          text: "Sistem embedded atau perangkat IoT",
          scores: {
            javascript: 1,
            typescript: 1,
            python: 3,
    ...
    {
      question: "Seberapa penting kemudahan pemeliharaan kode jangka panjang?",
      options: [
        {
          text: "Sangat penting - kode akan dipelihara selama bertahun-tahun",
          scores: {
            javascript: 3,
            typescript: 5,
            python: 4,
        ...
        {
          text: "Penting, tapi aku juga menghargai faktor lain",
          scores: {
            javascript: 3,
            typescript: 5,
            python: 4,
        ...
        {
          text: "Cukup penting - masa hidup proyek biasa",
          scores: {
            javascript: 4,
            typescript: 4,
            python: 4,
        ...
        {
          text: "Kurang penting - membangun prototipe atau proyek jangka pendek",
          scores: {
            javascript: 5,
            typescript: 3,
            python: 5,
        ...
        {
          text: "Aku lebih suka prototyping cepat daripada pemeliharaan jangka panjang",
          scores: {
            javascript: 5,
            typescript: 3,
            python: 5,
    ...
    {
      question: "Bagaimana toleransimu terhadap kurva belajar?",
      options: [
        {
          text: "Aku ingin langsung produktif",
          scores: {
            javascript: 5,
            typescript: 3,
            python: 5,
        ...
        {
          text: "Aku bersedia investasi waktu untuk belajar",
          scores: {
            javascript: 4,
            typescript: 4,
            python: 4,
        ...
        {
          text: "Aku bersedia investasi waktu signifikan untuk manfaat jangka panjang",
          scores: {
            javascript: 3,
            typescript: 5,
            python: 3,
        ...
        {
          text: "Aku suka mempelajari sistem kompleks secara menyeluruh",
          scores: {
            javascript: 3,
            typescript: 4,
            python: 3,
        ...
        {
          text: "Aku lebih suka keseimbangan antara kemudahan belajar dan kekuatan",
          scores: {
            javascript: 4,
            typescript: 4,
            python: 4,
    ...
    {
      question: "Seberapa penting kompatibilitas lintas platform?",
      options: [
        {
          text: "Sangat penting - harus berjalan di mana saja",
          scores: {
            javascript: 5,
            typescript: 5,
            python: 5,
        ...
        {
          text: "Penting untuk web dan platform desktop/mobile utama",
          scores: {
            javascript: 5,
            typescript: 5,
            python: 4,
        ...
        {
          text: "Terutama fokus pada satu platform",
          scores: {
            javascript: 4,
            typescript: 4,
            python: 4,
        ...
        {
          text: "Tidak penting untuk kasus penggunaanku",
          scores: {
            javascript: 3,
            typescript: 3,
            python: 3,
        ...
        {
          text: "Aku butuh tampilan dan nuansa native di setiap platform",
          scores: {
            javascript: 2,
            typescript: 2,
            python: 2,
    ...
    {
      question: "Apa preferensimu untuk sintaks dan gaya bahasa?",
      options: [
        {
          text: "Sintaks gaya-C (kurung kurawal, titik koma)",
          scores: {
            javascript: 5,
            typescript: 5,
            php: 5,
        ...
        {
          text: "Sintaks gaya-Python (whitespace signifikan)",
          scores: {
            javascript: 2,
            typescript: 2,
            php: 2,
        ...
        {
          text: "Sintaks gaya-Ruby (blok, return implisit)",
          scores: {
            javascript: 3,
            typescript: 3,
            php: 2,
        ...
        {
          text: "Gaya pemrograman fungsional",
          scores: {
            javascript: 2,
            typescript: 2,
            php: 1,
    ...
    {
      question: "Seberapa penting bahasa memiliki library standar yang lengkap?",
      options: [
        {
          text: "Sangat penting - aku lebih suka library standar yang komprehensif",
          scores: {
            javascript: 2,
            typescript: 3,
            python: 5,
        ...
        {
          text: "Cukup penting, tapi aku juga nyaman menggunakan paket pihak ketiga",
          scores: {
            javascript: 3,
            typescript: 4,
            python: 4,
        ...
        {
          text: "Tidak terlalu penting - aku lebih suka core minimal dengan paket",
          scores: {
            javascript: 5,
            typescript: 4,
            python: 3,
        ...
        {
          text: "Aku lebih suka library standar minimal",
          scores: {
            javascript: 5,
            typescript: 4,
            python: 2,
        ...
        {
          text: "Aku menghargai keseimbangan antara library standar dan paket eksternal",
          scores: {
            javascript: 4,
            typescript: 4,
            python: 4,
    ...
    {
      question: "Apa pendekatan penanganan error yang kamu sukai?",
      options: [
        {
          text: "Aku lebih suka exception untuk penanganan error",
          scores: {
            javascript: 4,
            typescript: 4,
            python: 5,
        ...
        {
          text: "Aku lebih suka nilai return/kode error",
          scores: {
            javascript: 3,
            typescript: 3,
            python: 2,
        ...
        {
          text: "Aku lebih suka tipe Result dan pattern matching",
          scores: {
            javascript: 2,
            typescript: 3,
            python: 2,
        ...
        {
          text: "Aku lebih suka kombinasi exception dan nilai return",
          scores: {
            javascript: 4,
            typescript: 4,
            python: 4,
    ...
    {
      question: "Seberapa penting typing yang kuat dan pemeriksaan saat kompilasi?",
      options: [
        {
          text: "Sangat penting - aku ingin keamanan maksimal saat kompilasi",
          scores: {
            javascript: 1,
            typescript: 5,
            python: 2,
        ...
        {
          text: "Penting, tapi aku juga menghargai fleksibilitas",
          scores: {
            javascript: 2,
            typescript: 5,
            python: 3,
        ...
        {
          text: "Agak penting, tapi bukan prioritas utama",
          scores: {
            javascript: 4,
            typescript: 4,
            python: 4,
        ...
        {
          text: "Tidak penting - aku lebih suka dynamic typing",
          scores: {
            javascript: 5,
            typescript: 2,
            python: 5,
        ...
        {
          text: "Aku lebih suka keseimbangan antara static dan dynamic typing",
          scores: {
            javascript: 3,
            typescript: 4,
            python: 3,
    ...
    {
      question: "Apa pendekatan concurrency yang kamu sukai?",
      options: [
        {
          text: "Async/await dan promises",
          scores: {
            javascript: 5,
            typescript: 5,
            python: 4,
        ...
        {
          text: "Message passing antar proses",
          scores: {
            javascript: 3,
            typescript: 3,
            python: 3,
        ...
        {
          text: "Aku tidak butuh banyak concurrency dalam aplikasiku",
          scores: {
            javascript: 4,
            typescript: 4,
            python: 4,
        ...
        {
          text: "Aku lebih suka reactive programming",
          scores: {
            javascript: 4,
            typescript: 5,
            python: 3,
    ...
    {
      question: "Seberapa penting keamanan memori?",
      options: [
        {
          text: "Sangat penting - harus mencegah error memori",
          scores: {
            javascript: 4,
            typescript: 4,
            python: 4,
        ...
        {
          text: "Aku lebih suka manajemen memori otomatis",
          scores: {
            javascript: 5,
            typescript: 5,
            python: 5,
    ...
    {
      question: "Apa lingkungan pengembangan yang kamu sukai?",
      options: [
        {
          text: "Visual Studio Code atau editor modern serupa",
          scores: {
            javascript: 5,
            typescript: 5,
            python: 5,
        ...
        {
          text: "IDE lengkap (IntelliJ, Visual Studio, dll)",
          scores: {
            javascript: 4,
            typescript: 5,
            python: 4,
        ...
        {
          text: "Editor teks ringan (Vim, Emacs, dll)",
          scores: {
            javascript: 4,
            typescript: 3,
            python: 4,
        ...
        {
          text: "Tools command-line dan scripting",
          scores: {
            javascript: 3,
            typescript: 3,
            python: 5,
    ...
    {
      question: "Seberapa penting permintaan pasar kerja untuk bahasa tersebut?",
      options: [
        {
          text: "Sangat penting - aku ingin peluang kerja maksimal",
          scores: {
            javascript: 5,
            typescript: 5,
            python: 5,
        ...
        {
          text: "Penting, tapi bukan satu-satunya pertimbanganku",
          scores: {
            javascript: 5,
            typescript: 5,
            python: 4,
        ...
        {
          text: "Agak penting, tapi aku lebih menghargai faktor lain",
          scores: {
            javascript: 4,
            typescript: 4,
            python: 4,
        ...
        {
          text: "Tidak penting - aku fokus pada alat yang tepat untuk pekerjaan",
          scores: {
            javascript: 3,
            typescript: 3,
            python: 3,
        ...
        {
          text: "Aku tertarik pada teknologi yang sedang berkembang dan tren masa depan",
          scores: {
            javascript: 4,
            typescript: 4,
            python: 4,
